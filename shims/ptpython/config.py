...
def configure(repl):
    ...
    # Keybinding: C-q -> [ESC]
    @repl.add_key_binding("c-q", filter=vi_insert_mode)
    def _(event):
        event.cli.key_processor.feed(
            KeyPress(Keys.Escape)
        )

    # Keybinding: C-a from Emacs vinding
    ...
    # Keybinding: C-e -> Move cursor to end with Suggest completion
    @Condition
    ...
    @repl.add_key_binding("c-e", filter=vi_insert_mode & suggestion_available)
    def _(event):
        """
        Accept suggestion.
        """
    ...
    # Keybinding: C-e from Emacs vinding
    @repl.add_key_binding("c-e", filter=vi_insert_mode & ~suggestion_available)
    def _(event):
    ...
    # mode.)
    """
    @repl.add_key_binding('j', 'j', filter=vi_insert_mode)
    def _(event):
        " Map 'jj' to Escape. "
